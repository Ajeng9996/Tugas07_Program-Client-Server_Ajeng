package com.appsgm.app.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appsgm.app.data.model.ActionState
import com.appsgm.app.data.model.AuthUser
import com.appsgm.app.util.getObject
import com.appsgm.app.util.putObject
...
class AuthPref(val context:Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        val user = authUser
        return if (user == null) {
            ActionState(message = "Anda belum terdapfat, isSuccess: = false")
